...
def template_lstsq(time: np.ndarray,
    ...
    duration_lims, _, _ = grid.get_transit_duration_limits(period_grid,
    ...
    power = np.zeros_like(period_grid)
    dchisq_dec = np.zeros_like(period_grid)
    dchisq_inc = np.zeros_like(period_grid)
    best_period = np.nan
